            ...
            */
            ...
            var ReactFiberClassComponent = function (scheduleWork, computeExpirationForFiber, memoizeProps, memoizeState) {
              ...
              function mountClassInstance(workInProgress, renderExpirationTime) {
                ...
                if (workInProgress.type != null && workInProgress.type.prototype != null && workInProgress.type.prototype.unstable_isAsyncReactComponent === true) {
            ...
            var ReactFiberReconciler$1 = function (config) {
              ...
              function scheduleTopLevelUpdate(current, element, callback) {
                ...
                if (element != null && element.type != null && element.type.prototype != null && element.type.prototype.unstable_isAsyncReactComponent === true) {
                  expirationTime = computeAsyncExpiration();
                } else {
            ...
            var require$$1$1 = ( reactDom_development$1 && reactDom_development ) || reactDom_development$1;
            ...
            var css = "@import url('https://fonts.googleapis.com/css?family=Roboto:300,400,500,700');\n\n* {\n  box-sizing: border-box;\n  font-family: \"Roboto\", sans-serif;\n}\n\nbody {\n  margin: 0;\n  padding: 0;\n}\n\n.mr-20 {\n  margin-right: 20px !important;\n}\n";
            styleInject(css);
            ...
            var SignUpForm = function (_Component) {
                ...
                function SignUpForm() {
                    ...
                    var _this = possibleConstructorReturn(this, (SignUpForm.__proto__ || Object.getPrototypeOf(SignUpForm)).call(this));
                ...
                createClass(SignUpForm, [{
                    ...
                    value: function render() {
                        return react.createElement(
                            ...
                            react.createElement(
                                'form',
                                { onSubmit: this.handleSubmit, className: 'FormFields' },
                                react.createElement(
                                    'div',
                                    { className: 'FormField' },
                                    react.createElement(
                                        'label',
                                        { className: 'FormField__Label', htmlFor: 'name' },
                                        'Full Name'
                                    ),
                                    react.createElement('input', { type: 'text', id: 'name', className: 'FormField__Input', placeholder: 'Enter your full name', name: 'name', value: this.state.name, onChange: this.handleChange })
                                ),
                                react.createElement(
                                    'div',
                                    { className: 'FormField' },
                                    react.createElement(
                                        'label',
                                        { className: 'FormField__Label', htmlFor: 'password' },
                                        'Password'
                                    ),
                                    react.createElement('input', { type: 'password', id: 'password', className: 'FormField__Input', placeholder: 'Enter your password', name: 'password', value: this.state.password, onChange: this.handleChange })
                                ),
                                react.createElement(
                                    'div',
                                    { className: 'FormField' },
                                    react.createElement(
                                        'label',
                                        { className: 'FormField__Label', htmlFor: 'email' },
                                        'E-Mail Address'
                                    ),
                                    react.createElement('input', { type: 'email', id: 'email', className: 'FormField__Input', placeholder: 'Enter your email', name: 'email', value: this.state.email, onChange: this.handleChange })
                                ),
                                react.createElement(
                                    'div',
                                    { className: 'FormField' },
                                    react.createElement(
                                        ...
                                        react.createElement('input', { className: 'FormField__Checkbox', type: 'checkbox', name: 'hasAgreed', value: this.state.hasAgreed, onChange: this.handleChange }),
                                ...
                                react.createElement(
                                    ...
                                    react.createElement(
                                        reactRouterDom.Link,
                                        { to: '/sign-in', className: 'FormField__Link' },
                                        'I\'m already member'
                                    )
                                )
                            )
            ...
            var SignInForm = function (_Component) {
                inherits(SignInForm, _Component);

                function SignInForm() {
                    classCallCheck(this, SignInForm);

                    var _this = possibleConstructorReturn(this, (SignInForm.__proto__ || Object.getPrototypeOf(SignInForm)).call(this));
                ...
                createClass(SignInForm, [{
                    ...
                    value: function render() {
                        return react.createElement(
                            ...
                            react.createElement(
                                'form',
                                defineProperty({ onSubmit: this.handleSubmit, className: 'FormFields' }, 'onSubmit', this.handleSubmit),
                                react.createElement(
                                    'div',
                                    { className: 'FormField' },
                                    react.createElement(
                ...
                value: function render() {
                  return react.createElement(
                    ...
                    react.createElement(
                      'div',
                      { className: 'App' },
                      react.createElement('div', { className: 'App__Aside' }),
                      react.createElement(
                        'div',
                        { className: 'App__Form' },
                        react.createElement(
                          ...
                          react.createElement(
                            ...
                            { to: '/sign-in', activeClassName: 'PageSwitcher__Item--Active', className: 'PageSwitcher__Item' },
                            'Sign In'
                          ),
                          react.createElement(
                            reactRouterDom.NavLink,
                            { exact: true, to: '/', activeClassName: 'PageSwitcher__Item--Active', className: 'PageSwitcher__Item' },
                            'Sign Up'
                          )
                        ),
                        react.createElement(
                          ...
                          react.createElement(
                            reactRouterDom.NavLink,
                            { to: '/sign-in', activeClassName: 'FormTitle__Link--Active', className: 'FormTitle__Link' },
                            'Sign In'
                          ),
                          ' or ',
                          react.createElement(
                            reactRouterDom.NavLink,
                            { exact: true, to: '/', activeClassName: 'FormTitle__Link--Active', className: 'FormTitle__Link' },
                            'Sign Up'
                          )
                        ),
                        react.createElement(reactRouterDom.Route, { exact: true, path: '/', component: SignUpForm }),
                        react.createElement(reactRouterDom.Route, { path: '/sign-in', component: SignInForm })
                      )
                    )
                  );
                }
